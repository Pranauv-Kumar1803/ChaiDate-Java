...
public class userOperations {
    ...
    public static void searchById(int id)
    {
        try{
            ...
            ResultSet set = stmt.executeQuery("select id,name,age,gender,socialHandles from users where id="+id+";");
            ...
            else
            {
                while(set.next())
                {
                    ...
                    System.out.println("Social Handle : "+sh);
                    System.out.println("--------------------------------------------");
