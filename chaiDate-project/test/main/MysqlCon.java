...
import test.import_CSV_FILES.getSQLcommandCSV;
...
class MysqlCon{
    ...
    public static void main(String args[]) throws SQLException, ParseException {
        ...
        int response = -1;
        while(true){
            System.out.println("Enter 1 if you are admin and 0 if you are user");
            adminCheck = in.nextInt();
            if(adminCheck==1){
                int adminOptions;
                System.out.println("1 to Search Users by id\n2 to delete Users\n3 to search users by partial name");
                adminOptions = in.nextInt();
                switch (adminOptions){
                    case 1:
                    ...
                    case 3:
                        ...
                        String nameSearchAdmin = in.nextLine();
                        System.out.println("The results for the Name "+nameSearchAdmin+" are as follows");
                        userOperations.searchByName(nameSearchAdmin);
...
//                if(flag==-1) break;
            ...
            else if(response==2 && adminCheck==1)
            {
                //admin only can upload and update the CSV file into the Database
                String del = getSQLcommandCSV.getDeleteCommand();
